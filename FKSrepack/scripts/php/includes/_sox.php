...
----------------------------------------------*/
	function Start(){
		$host = $this->server_params['host'];
		$port = $this->server_params['port'];
...
----------------------------------------------*/
	...
	function bind($type, $func){
		if(!isset($this->wsOnEvents[$type])){ $this->wsOnEvents[$type] = array(); }
