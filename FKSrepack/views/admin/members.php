<?PHP
	...
	$Manager->checkAccess('members', 1, true);
?>
<div id="crumbs">
	<div class="bar">
		<div class="trail">
...
<div class="fks-page-title">
	...
	<span class="subtitle d-none d-md-inline">list of all members</span>
</div>
<div class="row">
	<div class="col-md-12">
		<div id="members_panel" class="fks-panel">
			<div class="header">
				<span class="title">
					Members Table
				</span>
				<span class="actions">
					<a class="btn add-table" fks-access="2"><i class="fa fa-plus"></i><span class="d-none d-lg-inline"> Add Member</span></a>
