<?PHP
	...
	$Manager->checkAccess('admin_announcements', 1, true);
?>
<div id="crumbs">
	<div class="bar">
		<div class="trail">
...
<div class="fks-page-title">
	...
	<span class="subtitle d-none d-md-inline">create and modify announcements</span>
</div>
<div class="row">
	<div class="col-md-12">
		<div id="announcements_panel" class="fks-panel">
			<div class="header">
				<span class="title">
					Announcements Table
				</span>
				<span class="actions">
					<a class="btn add-table" fks-access="2"><i class="fa fa-plus"></i><span class="hidden-lg-down"> Add Announcement</span></a>
					<a class="btn reload-table"><i class="fa fa-refresh"></i><span class="hidden-lg-down"> Reload</span></a>
					<div class="btn-group">
						<a class="btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-columns"></i><span class="hidden-lg-down"> Columns</span> <i class="fa fa-angle-down"></i></a>
